...
- 2026-05-07:
  - AiTrain: MixedRadixPosiionalNotation
    - try teaching by example, based on nN solutions that start out from a recognized CamelCase field value
- 2026-05-05
...
- explore more of the nuances of TransClude (TW) versus InJect (TB)
  - this may just be a matter of dev. "comfort" and familiarity
      ...
      - Sponsored?
        - determine what the sponsorship level can be based on the $25,000 annualy as an HST limit & likely CAD/USD
          - TA needs to review his situation and decide
            - realTime performance still appears problematic
...
- 0403:
  - ...
    ...
    #### [plans](https://github.com/HwWobbe/DefinitiveData-DeltaAlerts/blob/main/README.md#2024-04-1)
